...
const assignuser = async (req, res) => {
    try {
          let maneger= await dbops.admindata.findOne({where:{username:req.body.manger}});
          let user = await dbops.admindata.findOne({where:{username:req.body.user}});
...
module.exports = { register, login, updateroles, assignuser ,changePassword}